...
def parse_args():
    ...
    parser.add_argument('__fp16', default=False, action='store_true', help="Enable mixed precision training")
    ...
    parser.add_argument('--lr', type=float, default=0.000001, help="the learning rate")
...
def postprocess_args(args):
    ...
    # Setup input paths
    ft_file_map = {
        'vitbase': 'dino_features_36_vit_b14.hdf5',
        'dino_imagenet': 'dino_features_36_1768dim.hdf5',
    }
